...
const routes: Routes = [
  ...
  {path: 'listingDetails', component: JobListingDetailsComponent, canActivate: [ AuthGuard]},
  {path: 'browseJobListing', component: JobListingBrowseComponent, canActivate: [ AuthGuard] },
